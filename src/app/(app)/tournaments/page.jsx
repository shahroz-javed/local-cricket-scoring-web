      ...
      <div className="max-w-4xl">
        ...
        {!loading && !error && tournaments.length === 0 && (
          <div className="bg-surface rounded-2xl border border-outline-variant p-12 text-center">
            ...
            <h3 className="font-display text-xl font-bold text-foreground mb-2">No tournaments yet</h3>
            <p className="text-foreground-muted text-sm mb-6 max-w-sm mx-auto">
              Create your first tournament — league, knockout, or combined. Fixtures generate automatically.
            </p>
            <Link
              href="/create-tournament"
        ...
        {!loading && !error && tournaments.length > 0 && (
          <div className="space-y-3">
            {tournaments.map(t => {
              ...
              return (
                <div key={t.code} className="bg-surface rounded-2xl border border-outline-variant overflow-hidden hover:border-primary/40 transition-colors">
